...
The highest-leverage layer: the mode isn't "do everything yourself at frontier quality," it's **fan the breadth out and author the judgment inline.**
...
- **Adopt the biggest-miss.** End every war-game by asking "what did this whole exercise miss?" — and when the answer is real, promote it into the plan.
